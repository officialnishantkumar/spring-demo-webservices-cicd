...
public class ProductApi {
	...
	public ResponseEntity<List<Product>> findProductByPrice(@PathVariable("price")Double price){
		return new ResponseEntity<>(repository.findByPriceGreaterThanEqual(price).get(),HttpStatus.OK);
		
	}
	@GetMapping("/findByPriceEq/{price}")
	public ResponseEntity<List<Product>> findProductByPriceEq(@PathVariable("price")Double price){
